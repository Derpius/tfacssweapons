...
SWEP.Purpose = "Compact bullpup personal defence weapon with an integrated reflex sight" -- Purpose Tooltip
...
-- [[WEAPON HANDLING]] --
SWEP.Primary.Sound = Sound("Weapon_P90.1") -- This is the sound of the weapon, when you shoot.
...
-- Firing Cone Related
SWEP.Primary.Spread = 0.003 -- This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
...
SWEP.Primary.RangeFalloffLUT = {
	...
	lut = { -- providing zero point is not required
		...
		{range = 100, damage = 1},
		{range = 150, damage = 0.98},
		{range = 200, damage = 0.94},
		{range = 250, damage = 0.86},
		{range = 300, damage = 0.8},
		{range = 400, damage = 0.3},
		{range = 500, damage = 0},
	}
}
...
SWEP.IronSightsMoveSpeed = 0.95*0.6 -- Multiply the player's movespeed by this when sighting.

-- VIEWMODEL
SWEP.ViewModel = "models/weapons/cstrike/c_smg_p90.mdl" -- Viewmodel path
...
-- WORLDMODEL
SWEP.WorldModel = "models/weapons/w_smg_p90.mdl" -- Weapon world model path
SWEP.HoldType = "rpg" -- This is how others view you carrying the weapon.
SWEP.Offset = {
	Pos = {
		Up = 0,
		Right = 0,
...
SWEP.IronSightsPos = Vector(-5.71, -17.286, 2.23)
...
-- [[RENDER TARGET]] --
local scopeMat = Material("scope/csgo_dot")
...
SWEP.RTCode = function(self)
	render.RenderView({
		origin = LocalPlayer():GetViewModel():LocalToWorld(Vector(0, -6, -3)),
		angles = LocalPlayer():GetViewModel():GetAngles(),
		drawviewmodel = false,
		w = 1024,
		h = 512,
		fov = 14,
	...
	render.DrawScreenQuadEx(938, 254, 700, 200)
end
