...
SWEP.Purpose = "General purpose US assault rifle" -- Purpose Tooltip
...
SWEP.Weight = 29            -- This controls how "good" the weapon is for autopickup.
SWEP.DrawWeaponInfoBox = true -- Should draw the weapon info box
SWEP.DrawAmmo = true -- Should draw the default HL2 ammo counter

-- [[WEAPON HANDLING]] --
SWEP.Primary.Sound = Sound("Weapon_M4A1.1") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("Weapon_M4A1.2") -- This is the sound of the weapon, when silenced.
...
SWEP.IronSightsMoveSpeed = 0.9*0.6 -- Multiply the player's movespeed by this when sighting.

-- VIEWMODEL
SWEP.ViewModel = "models/weapons/cstrike/c_rif_m4a1.mdl" -- Viewmodel path
...
-- WORLDMODEL
SWEP.WorldModelUnsuppressed = "models/weapons/w_rif_m4a1.mdl"
SWEP.WorldModelSuppressed = "models/weapons/w_rif_m4a1_silencer.mdl"
...
SWEP.IronSightsPos = Vector(-7.87, -1.772, 0.13)
